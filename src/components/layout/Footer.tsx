...
export function Footer() {
  return (
    <footer className="bg-midnight-light border-t border-glass-border pt-16 pb-8 text-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Shop Links */}
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Магазин</h4>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Покупателям</h4>
            <ul className="space-y-2 text-sm text-gray-400">
          ...
          {/* Newsletter / Socials */}
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase tracking-wider text-white">Мы в соцсетях</h4>
            <div className="flex gap-4 mb-6">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-neon-pink hover:text-white transition-all">
        ...
        <div className="border-t border-glass-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs text-gray-500">
            ...
            <Link href="/terms" className="hover:text-white">Публичная оферта</Link>
          </div>
        </div>
      </div>
    </footer>
